            ...
            if counter != 0:
                ...
                if counter == 1:
                    ...
                    if secondsElapsed > 30:    
                        ...
                        studentInfo['Attendances'] += 1
                        ref.child('Attendances').set(studentInfo['Attendances'])
                ...
                if modeType != 3:              
                    ...
                    if counter<=10:
                        cv2.putText(imgBackground,str(studentInfo['Attendances']),(861,125),cv2.FONT_HERSHEY_COMPLEX,1,(255,255,255),1)
                        # cv2.putText(imgBackground,str(studentInfo['Name']),(909,445),cv2.FONT_HERSHEY_COMPLEX,1,(50,50,50),1)
                        cv2.putText(imgBackground,str(id),(1006,493),cv2.FONT_HERSHEY_COMPLEX,0.6,(255,255,255),1)
                        cv2.putText(imgBackground,str(studentInfo['Field']),(1006,550),cv2.FONT_HERSHEY_COMPLEX,0.5,(255,255,255),1)
